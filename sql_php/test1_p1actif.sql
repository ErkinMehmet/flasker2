...
LOCK TABLES `p1actif` WRITE;
/*!40000 ALTER TABLE `p1actif` DISABLE KEYS */;
INSERT INTO `p1actif` VALUES (124,10,1,2),(125,10,0,11);
/*!40000 ALTER TABLE `p1actif` ENABLE KEYS */;
UNLOCK TABLES;
