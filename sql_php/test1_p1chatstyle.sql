...
--
-- Dumping data for table `p1chatstyle`
--

LOCK TABLES `p1chatstyle` WRITE;
/*!40000 ALTER TABLE `p1chatstyle` DISABLE KEYS */;
/*!40000 ALTER TABLE `p1chatstyle` ENABLE KEYS */;
UNLOCK TABLES;
